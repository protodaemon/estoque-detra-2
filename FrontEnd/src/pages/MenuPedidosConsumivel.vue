  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-white">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <div class="flex items-center text-sm text-gray-600 mt-1 space-x-2">
                ...
                <ChevronRight class="w-4 h-4" />
                <span class="text-blue-600 font-medium">Menu Pedidos</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="flex items-center justify-center min-h-[calc(90vh-80px)] p-6">
      ...
      <div class="max-w-4xl w-full grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div class="bg-gradient-to-r from-blue-500 to-blue-700 p-8 text-white relative">
            ...
            <div class="relative z-10">
              ...
              <h2 class="text-2xl font-bold mb-2">Registrar Pedido</h2>
              <p class="text-white/80">Novos pedidos de produtos consumíveis</p>
            </div>
          </div>
          ...
          <div class="p-8">
            <div class="flex items-center justify-between text-gray-600">
              <div>
                ...
                <p class="text-xs text-gray-400">Adição de pedido</p>
              </div>
        ...
        <!-- Card Consultar -->
        <div 
          @click="navegar('/consultar-pedido')"
          class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:scale-105 overflow-hidden group"
        >
          <!-- Header do Card -->
          <div class="bg-gradient-to-r from-green-500 to-green-700 p-8 text-white relative">
            ...
            <div class="relative z-10">
              ...
              <h2 class="text-2xl font-bold mb-2">Consultar Pedidos</h2>
              <p class="text-white/80">Consulta de pedidos realizados</p>
            </div>
          </div>
          ...
          <div class="p-8">
            <div class="flex items-center justify-between text-gray-600">
              <div>
                ...
                <p class="text-xs text-gray-400">Consulta de consumíveis</p>
              </div>
