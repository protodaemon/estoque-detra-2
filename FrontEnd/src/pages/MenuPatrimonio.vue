    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h1 class="text-2xl font-bold text-gray-800">Gerenciar Patrimônios</h1>
            <div class="flex items-center text-sm text-gray-600 mt-1">
              <span class="text-gray-400">Menu</span>
              <ChevronRight class="w-4 h-4 mx-1" />
              <span class="text-blue-600">Menu Patrimônio</span>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      opcoes: [
        {
          titulo: 'Estoque Patrimonio',
          rota: '/estoque-patrimonio',
          icone: 'Palette',
          descricao: 'Gerencie patrimônio público',
          cor: 'blue',
          badge: null
        },
        /*{
        ...
        },*/
        {
          ...
          rota: '/entrada-patrimonio',
          icone: 'Truck',
          descricao: "Gerenciar entrada de novos produtos em estoque",
          cor: 'rose',
          badge: null
        }
      ]
